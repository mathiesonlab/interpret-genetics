...
if __name__ == "__main__":
    ...
    """
    msms_gen = Schrider_Generator(10, 1000000, 8000, 1000, 10000, yield_summary_stats=0)
    generator = msms_gen.data_generator(3000)
    
    [X, distances], y = next(generator)
    
    with open("schrider_X_test.keras", 'wb') as f:
        pickle.dump(X, f)
    with open("schrider_distances_test.keras", "wb") as f:
        pickle.dump(distances, f)
    with open("schrider_y_test.keras", 'wb') as f:
        pickle.dump(y, f)
